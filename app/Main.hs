...
main = do
    ...
    let world = WN.HeightMapInfo 234233 20
        img = Img.makeImage (1000, 1000) (\(x, y) -> Img.PixelY $ WN.worleyNoise world (fromIntegral x, fromIntegral y)) :: Img.Image Img.VU Img.Y Double
